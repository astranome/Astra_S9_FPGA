...
HD_PWD='E:/Linux14_1/Linux14_1.runs/system_ps2_mouse_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ps2_mouse_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ps2_mouse_0_0.tcl
