...
HD_PWD='C:/Xilinx/Projects/Gen4/Gen4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gener4_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gener4_wrapper.tcl
