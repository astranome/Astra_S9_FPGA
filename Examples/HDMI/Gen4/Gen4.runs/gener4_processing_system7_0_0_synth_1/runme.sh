...
HD_PWD='C:/Xilinx/Projects/Gen4/Gen4.runs/gener4_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gener4_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gener4_processing_system7_0_0.tcl
