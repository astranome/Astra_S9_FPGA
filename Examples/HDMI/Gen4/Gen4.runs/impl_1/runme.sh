...
HD_PWD='C:/Xilinx/Projects/Gen4/Gen4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gener4_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gener4_wrapper.tcl -notrace
