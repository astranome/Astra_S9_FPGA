...
BEGIN OS
 ...
 PARAMETER bootargs = mem=496M console=ttyPS0,115200 ramdisk_size=409600 root=/dev/mmcblk0p2 rootfstype=ext4 rw elevator=deadline rootwait
 PARAMETER console_device = ps7_uart_1
 PARAMETER firmware_name = Astra1
