...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA2_PERIPHERAL_FREQMHZ {60.606064} \
   CONFIG.PCW_ACT_FPGA3_PERIPHERAL_FREQMHZ {23.809525} \
   ...
   CONFIG.PCW_CLK2_FREQ {60606064} \
   CONFIG.PCW_CLK3_FREQ {23809525} \
   ...
   CONFIG.PCW_FCLK3_PERIPHERAL_DIVISOR0 {42} \
   ...
   CONFIG.PCW_NAND_CYCLES_T_REA {7} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M04_AXI [get_bd_intf_pins axi_uartlite_0/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M04_AXI]
  ...
  connect_bd_net -net ps2_mouse_0_mouse_data [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins ps2_mouse_0/mouse_data]
  connect_bd_net -net ps2_mouse_0_mouse_data_new [get_bd_pins ps2_mouse_0/mouse_data_new] [get_bd_pins xlconcat_0/In3]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_dynclk_0/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_hdmi/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins ps2_mouse_0/reset_n] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins v_tc_0/s_axi_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_hdmi/S_AXI/Reg] SEG_axi_gpio_0_Reg
