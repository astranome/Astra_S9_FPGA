...
HD_PWD='E:/SDR_HDMI_PS2-main/IP_ps2_mouse/IP_ps2_mouse.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps2_mouse_w.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps2_mouse_w.tcl
